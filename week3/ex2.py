...
def initialize_parameters(n_x, n_h, n_y):
    # 假若把W都初始化为0矩阵，由于所有的隐含单元都是对称的，无论你运行梯度下降多久，他们一直计算同样的函数
    # 关于0.01：如果初始化很大，那么激活函数的自变量z就很大，此时激活函数倒数特别小，影响梯度下降效率
    # 当训练一个深层网络时要选择一个比0.01更小的数
...
def backward_propagation(parameters, cache, X, Y):
    ...
    A1 = cache["A1"]
    A2 = cache["A2"]
    # dZ1用的是dL/dZ1 dZ2同dZ1  其他的都是dJ/d*
    dZ2 = A2 - Y
